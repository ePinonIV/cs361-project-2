# CS361-project-2
Repository to hold code for CS361L Data Structures and Algorithms Project-2 about Dijkstra's Algorithm
...
```
python3 v1_array_based_dijkstra.py
```

To run the Version 2 Priority Queue Implementation of Dijkstra's Algorithm:
```
python3 v2_priority_queue_dijkstra.py
```

NOTE: the runtimes and memory usage will vary depending on the pysical hardware of each device, so they may not exactly match that of the results in our report.